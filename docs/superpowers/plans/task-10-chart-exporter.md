# Task 10: Chart Block Exporter

**Files:**
- Create: `starter-components/export/pptx/block-exporters/chart.ts`

**Interfaces:**
- Consumes: chart block, PptxExportContext
...
```bash
git add starter-components/export/pptx/block-exporters/chart.ts
git commit -m "feat: add chart block exporter for PPTX"
```
