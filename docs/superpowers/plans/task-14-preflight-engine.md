# Task 14: Export Preflight Engine

**Files:**
- Create: `starter-components/export/export-preflight.ts`

**Interfaces:**
- Consumes: DeckProject, PptxExportConfig
- Produces: ExportPreflightResult

## Steps

- [ ] **Step 1: Create export-preflight.ts**
...
```bash
git add starter-components/export/export-preflight.ts
git commit -m "feat: add export preflight engine with fidelity scoring"
```
