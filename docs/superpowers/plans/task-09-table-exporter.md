# Task 9: Table Block Exporter

**Files:**
- Create: `starter-components/export/pptx/block-exporters/table.ts`

**Interfaces:**
- Consumes: table block, PptxExportContext
...
```typescript
// starter-components/export/pptx/block-exporters/table.ts
...
```bash
git add starter-components/export/pptx/block-exporters/table.ts
git commit -m "feat: add table block exporter for PPTX"
```
