# Task 4: Font Detection

**Files:**
- Create: `starter-components/export/pptx/pptx-fonts.ts`

**Interfaces:**
- Consumes: font references from DeckProject blocks
- Produces: FontWarning[] for preflight

## Steps

- [ ] **Step 1: Create pptx-fonts.ts**

```typescript
// starter-components/export/pptx/pptx-fonts.ts
...
```bash
git add starter-components/export/pptx/pptx-fonts.ts
git commit -m "feat: add font detection and substitution warnings"
```
